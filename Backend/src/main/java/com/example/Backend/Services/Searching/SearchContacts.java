...
public class SearchContacts {
    ...
    public ArrayList<Contact> searchByName(String Name, String emailAddress) {
    ...
    public ArrayList<Contact> searchByEmailAddress(String userEmailAddress, String emailAddressToBeSearched) {
        ArrayList<Contact> res = new ArrayList<>();
